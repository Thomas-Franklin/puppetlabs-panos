  ...
  describe Puppet::Transport::Panos do
    ...
    describe '#new' do
      ...
      context 'when host is not provided' do
        let(:connection_info) { { user: 'admin', password: pass } }
      ...
      context 'when port is provided but not valid' do
        let(:connection_info) { { host: 'www.example.com', port: 'foo', user: 'admin', password: pass } }
      ...
      context 'when valid user credentials are not provided' do
        [
          ...
          { host: 'www.example.com', password: Puppet::Pops::Types::PSensitiveType::Sensitive.new('password') },
      ...
      context 'when correct credentials are provided' do
        let(:connection_info) { { host: 'www.example.com', user: 'foo', password: pass } }
